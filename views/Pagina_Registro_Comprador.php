...
<body>
    ...
    <section class="container">
        <div class="row mt-3">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8 mx-auto pb-3">
                <!-- Campos Obligatorios -->
                    ...
                    <div class="row">
                        ...
                        <div>
                            ...
                            <div class="d-grid p-3">
                                <button class="btn btn-danger btn-lg" type="submit" data-bs-toggle='modal' data-bs-target='#registro_Pasajeros'>Registrar Pasajeros</button>
                            </div>
                        </div>
                    </div>
