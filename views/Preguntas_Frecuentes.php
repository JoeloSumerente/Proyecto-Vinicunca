                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <p class="text-justify">Para ir a la montaña de los siete colores usted debe estar
                                        listo o
                                        dispuesto para el
                                        cambio intensivo del clima. El tiempo que es adecuado para viajar, es en tiempo
                                        de
                                        sequía o cosecha andino, desde el mes de abril a octubre o como otros la llaman
                                        verano
                                        andino. Por su comodidad y seguridad, debes escoger el equipo adecuado antes de
                                        viajar.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <p class="text-justify">Hay dos formas de ir, una contratando una agencia de viajes
                                        ...
                                        puedes escoger la segunda opción, pero primero debes consultar a personas que
                                        conocen el lugar, además, debes saber dónde coger un auto para poder llegar, a
                                        la montaña de los siete colores.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <p class="text-justify">Estar seguro de tu buen estado de salud, sentirse al cien
                                        ...
                                        cada uno, recomendable ir a su doctor a hacerse una revisión sobre su salud.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseSix" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <p class="text-justify">La montaña de los siete colores esta 5.200 metros de altura
                                        ...
                                        mareos, insomnios, pérdida de apetito y pérdida de energía. Para no ser afectado
                                        por la altura recomendable ir antes a consulta con su Doctor.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseSeven" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <p class="text-justify">La ropa con el que se sienta cómoda y se sienta capaz de dar
                                        ...
                                        peses y unos buenos zapatos de trekking por supuesto un sombrero para
                                        protegernos de sol.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseEight" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <p class="text-justify">Es necesario llevar alcohol medicinal, mate de coca, ti
                                        ...
                                        el abrigo obvio que es necesario.</p>
                                </div>
                            </div>
                        </div>
                    </div>
